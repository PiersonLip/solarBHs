...
\begin{document}
    ...
    \caption{Note that these were simply constrained based on the max and min of the initial masses. Next step is actually sampling from a proper matching distribution}
