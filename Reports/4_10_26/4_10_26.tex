...
\begin{document}
    ...
    Setup \verb|BH-Sol_Filter.py| to use multiprocessing, cutting time down for filtering into the BH-Sol canidates massively.
    ...
    \item How should i sort for failed CE systems? My plan was to find the init CE mass distribution from the BH-Sol pop, constrain the main pop to that, and then constrain that to ones where their next step is merging
    \item Next steps probably involve higher res grids + 10 mill sim? 
    \end{list}

    \pagebreak
    \section{\(1-.01Z_\odot\) Graphs}
    \hrule
    \vspace{.5cm}
