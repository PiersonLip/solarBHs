...
\hrule
\vspace{.5cm}
When filtering via notebook and via sciript, both returned 6 systems that had \(p_{orb} < 3.5, M_{\odot,2} < 3, t < 10e9\)
...
These systems then evolve in a semi-partiuclar way, where it is highy likely that there will be RLO from S2 onto S1, and because S1 > S2, this is stable, and leads to \textit{very} prolonged stable RLO (seemingly on the scale of  \(> 14 Gyr\)), which leaves S2 at low masses (\(< .08 M_\odot\)).
